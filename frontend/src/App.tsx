...
export default function App() {
  ...
  // 🔴 EKLENDİ: backend validation hataları için
  ...
  const submitProfile = async () => {
    try {
      setErrors([]); // 🔴 önce eski hataları temizle
      ...
      // 🔴 EKLENDİ: backend validation mesajlarını yakala
  ...
  const editProfile = (profile: Profile) => {
    ...
    setErrors([]); // 🔴 edit’e geçerken hataları temizle
